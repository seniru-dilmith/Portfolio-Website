...
// Mock remark and strip-markdown to prevent ESM syntax errors in Jest
jest.mock('remark', () => ({
    remark: jest.fn(() => ({
        use: jest.fn().mockReturnThis(),
        processSync: jest.fn((content) => ({
            toString: () => content,
        })),
    })),
}));
jest.mock('strip-markdown', () => jest.fn());
...
describe("ArticleList", () => {
    ...
    it("renders article titles and content summaries", () => {
        // FIX: Added missing handleLogin and handleLogout properties to the mock
